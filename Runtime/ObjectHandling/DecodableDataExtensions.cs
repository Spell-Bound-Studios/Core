...
namespace Spellbound.Core {
    public static class DecodableDataExtensions {
        ...
        public static IDecodableData GetDefaultData<T>(this T data, ObjectPreset preset, int surfaceIndex, byte level = 1)
        ...
        public static void ChangeCallback<T>(this T data, byte context, IObjectDataAccess dataAccess, 
        ...
        public static void ResolveCallback<T>(this T data, byte context, IObjectDataAccess dataAccess,
            int instanceIndex, ObjectPreset preset, int surfaceIndex, TransformData transformData)
                where T : IDecodableData {
