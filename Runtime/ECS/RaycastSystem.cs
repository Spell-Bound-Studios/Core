...
namespace SpellBound.Core {
    ...
    public partial class RaycastSystem : SystemBase, ISystemStartStop {
        ...
        protected override void OnCreate() {
            RequireForUpdate<ProxyEntityTag>();
        }
        
        [BurstCompile]
        public void OnStartRunning(ref SystemState state) {
            _firedNullEvent = false;
        }
        ...
        private bool GoRaycast(float3 start, float3 direction, out ObjectPreset op, out float distance, out FixedString64Bytes ngoId) {
            op = null;
            distance = float.MaxValue;
            ngoId = default;
